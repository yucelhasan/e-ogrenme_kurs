...
# Certificate modeli buraya eklendi
from lms_app.models import InstructorApplication, Certificate
...
def profile_view(request):
    ...
    # Kullanıcının kayıtlı olduğu kurslar ve ilerlemeleri
    enrollments = get_user_enrolled_courses_with_progress(request.user)
    
    # %100 tamamlanan kurs sayısı
